#!/usr/bin/env python3
"""
pyVideoPostCompressMoverNDeleter.py (in user's bin)

Move files additional to videos (supposedly compressed in a previous run)
  and delete selected-file-extension videos
