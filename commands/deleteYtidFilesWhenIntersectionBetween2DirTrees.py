#!/usr/bin/env python3
"""
commands/deleteYtidFilesWhenIntersectionBetween2DirTrees.py
  Deletes repeated ytid files either from the source or destination dirtree,
    the user chooses from which one

This script does the following:
  1) it calls commands/reportDifferentYdidsFromToDirTree.py
...
"""
import os
import commands.reportDifferentYdidsFromToDirTree as modEquals  # .YtidsComparatorReporter
rule40dashsigns = '-'*40
rule40equalsigns = '='*40
