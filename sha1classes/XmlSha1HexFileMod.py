...
from sha1utils.hexfunctionsMod      import generate_sha1hexdigest_from_filepath
from sha1utils.Sha1XmlFileFunctions import read_xml_sha1file_into_sha1sum_and_filename_dict
from sha1utils.Sha1XmlFileFunctions import generate_xmlsha1file_on_folder
from sha1utils.Sha1XmlFileFunctions import hash_files_and_get_sha1sum_and_filename_dict_from_folder
from sha1utils.Sha1XmlFileFunctions import write_xml_sha1file
...
class XmlSha1HexFile(object):
  ...
  Internally, there are lots of methods in this class that should be "understood" as "private", for they
    manipulate the XML internally and should not be invoked by other classes.
