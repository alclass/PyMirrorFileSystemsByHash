...
DirTreeMirror_PrdPrjSw:
  cmm/del/deleteEmptyDirsCurrentAndUpwards.py

Deletes / removes empty directory in the target dirtree.

Usage:
  $deleteEmptyDirsCurrentAndUpwards.py <prunepath>

Example:
  $deleteEmptyDirsCurrentAndUpwards.py "/Science/Physics/Einsteinian Relativity"
...
def prune_dirtree_from_prunepath(prunepath):
  ...
  print('Report deleteEmptyDirsCurrentAndUpwards.py')
