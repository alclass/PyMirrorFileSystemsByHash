...
DirTreeMirror_PrdPrjSw:
  cmm/del/deleteExcessSha1DestinationFilesThatDoNotExistInSource.py
Description below.
...
Usage:
=====
$deleteExcessSha1DestinationFilesThatDoNotExistInSource.py <abspath-to-ori> <abspath-to-bak>

Example:
=======
$deleteExcessSha1DestinationFilesThatDoNotExistInSource.py "/media/user/disk_science_1" "/media/user/disk_science_2"
"""
import os.path
import sys
