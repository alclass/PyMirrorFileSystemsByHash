...
class FolderPathAjuster(object):
  '''
  This class has functionality to help ajust the abspath to the middlepath, ie, the os-absolute path must
    be stripped of the device_and_middle_path, remaining the relative path (ie, the middlepath)
  '''
